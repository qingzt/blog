  ...
  return (
    ...
    >
      <Toggle>
        ...
        <div className='absolute left-1/2 top-1/3 z-20 size-1/2 -translate-x-1/2 -translate-y-1/3 rounded-full bg-gradient-to-bl from-orange-300 via-orange-500 to-red-600 transition-all duration-1000 after:absolute after:right-0 after:top-0 after:size-3/4 after:origin-top-right after:scale-0 after:rounded-full after:bg-surface after:transition-transform after:duration-1000 after:content-["_"] group-hover:-translate-y-[15%] group-hover:scale-90 dark:from-slate-600 dark:via-indigo-600 dark:to-indigo-900 dark:after:scale-100' />
